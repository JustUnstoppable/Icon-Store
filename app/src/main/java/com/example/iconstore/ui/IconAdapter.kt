package com.example.iconstore.ui
...
import com.example.iconstore.BuildConfig
import com.example.iconstore.R
import com.example.iconstore.model.Icon
import com.example.iconstore.utils.*
import kotlinx.android.synthetic.main.grid_item.view.*
import retrofit2.http.Headers

class IconAdapter(var list: List<Icon>)
    ...
    inner class ViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private fun getDownloadUrl(baseUrl: String) =
            "$baseUrl?$CLIENT_ID=${BuildConfig.CLIENT_ID}&$API_KEY=${BuildConfig.API_KEY}"
    }
}